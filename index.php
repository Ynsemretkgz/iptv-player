...
<html lang="en">
   ...
   <body id="page-top">
      <nav class="navbar navbar-expand navbar-light bg-white static-top osahan-nav sticky-top">
		 ...
		 <h5><a href="index.php">IPTV Player <span class="logo_colour"></span></a></h5>
                     ...
                     <div class="col-md-12">
                            ...
                            <script>
                                ...
                                var player = new Clappr.Player({
                                    source: "http://bestbuyiptv.live:8080/live/azurynsemre1/IjapYjN6/19304.m3u8",
